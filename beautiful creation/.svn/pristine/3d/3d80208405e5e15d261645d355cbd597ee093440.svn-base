...
/**
 * Created by DK-user on 2016/5/3.
 */
public class MyItemsListAdapter extends BaseAdapter{
    private Context context;
    private List<Map<String, Object>> list = new ArrayList<Map<String, Object>>();
    public MyItemsListAdapter(Context context, List<Map<String, Object>> list) {
